...
Set Float Voltage if you send payload **[55.4....]** with topic **set_float_voltage**<br>
Control mppt ON/OFF if you send a payload **[1 for ON and 4 for OFF]** with topic **set_device_mode**<br>

# GET some mppt state values 
